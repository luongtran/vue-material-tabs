...
var __vue_render__$2 = function __vue_render__() {
  ...
  return _c('div', {
    ...
    class: _vm.classes
  }, [_vm._ssrNode("<div class=\"tab__pagination__prev\" data-v-fa5c1274>", "</div>", [_vm.pagination.has ? _c('Btn', {
    attrs: {
  ...
  }, [_vm._ssrNode("<ul class=\"tab__nav__items\"" + _vm._ssrStyle(null, _vm.styles, null) + " data-v-fa5c1274>", "</ul>", [_vm._l(_vm.navItems, function (navItem) {
    return _c('li', {
      directives: [{
        name: "ripple",
        rawName: "v-ripple",
  ...
  }), _vm._ssrNode(" " + (_vm.navSlider ? "<hr class=\"tab__slider\" data-v-fa5c1274>" : "<!---->"))], 2)]), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"tab__pagination__next\" data-v-fa5c1274>", "</div>", [_vm.pagination.has ? _c('Btn', {
    attrs: {
...
var __vue_inject_styles__$2 = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-fa5c1274_0", {
    source: ".tab__pagination[data-v-fa5c1274]{display:flex;justify-content:space-between;align-items:center;vertical-align:middle;max-width:100%;flex:0 1 auto;position:relative;contain:content}.tab__pagination .tab__pagination__prev[data-v-fa5c1274],.tab__pagination__next[data-v-fa5c1274]{flex:1 40px;min-width:40px}.tab__pagination__next[data-v-fa5c1274] .btn svg{transform:rotate(180deg)}.tab__nav[data-v-fa5c1274]{position:relative;display:flex;overflow:hidden;flex:1 100%}.tab__nav__items[data-v-fa5c1274]{display:flex;margin:0;padding:0;flex:1 auto;transition:.3s cubic-bezier(.25,.8,.5,1);height:100%}.tab__nav__items .tab__nav__item[data-v-fa5c1274]{list-style:none;text-align:center;cursor:pointer;padding:.9rem 1rem;letter-spacing:.0892857143em;display:flex;justify-content:center;align-items:center;text-align:center;text-transform:uppercase;font-size:.875rem;font-weight:500;white-space:normal;transition:background .1s ease;position:relative;overflow:hidden;min-width:90px;max-width:360px;user-select:none}.tab__nav__items .tab__nav__item[data-v-fa5c1274]:hover:not(.disabled,.active){background:hsla(0,0%,100%,.09)}.tab__nav__items .active[data-v-fa5c1274]:hover{background:hsla(0,0%,100%,.18)}.tab__nav__items .disabled[data-v-fa5c1274]{background:#6969694f}.tab__slider[data-v-fa5c1274]{height:2px;width:2px;border:none;margin:0;padding:0;bottom:0;position:absolute;transition:left .3s cubic-bezier(.25,.8,.5,1),top .3s cubic-bezier(.25,.8,.5,1)}.tab__pagination--vertical[data-v-fa5c1274]{flex-direction:column}.tab__pagination--vertical .tab__nav__items[data-v-fa5c1274]{flex-direction:column;flex:1 auto;position:relative}.tab__pagination--vertical .tab__nav__item *[data-v-fa5c1274]{padding:0;margin:0}.tab__pagination--vertical[data-v-fa5c1274] .tab__pagination__prev svg{transform:rotate(90deg)}.tab__pagination--vertical[data-v-fa5c1274] .tab__pagination__next svg{transform:rotate(270deg)}.tab__pagination--vertical .tab__nav__item[data-v-fa5c1274]{justify-content:left;padding-top:1.6rem;padding-bottom:1.6rem}.tab__pagination--auto .tab__nav__item[data-v-fa5c1274]{flex:1 auto}",
    map: undefined,
    media: undefined
  }), inject("data-v-fa5c1274_1", {
...
var __vue_scope_id__$2 = "data-v-fa5c1274";
/* module identifier */

var __vue_module_identifier__$2 = "data-v-fa5c1274";
/* functional template */
